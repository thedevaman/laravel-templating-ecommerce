...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-menu-modern 1-column   blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
            ...
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    <div class="card-title text-center">
                        <div class="p-1"><img src="images/logo/stack-logo-dark.png"
              ...
              <div> <span class='error' style="color: red;"></span></div>
                            ...
                            <button type="submit" name="btn" class="btn btn-primary btn-lg btn-block"><i
                ...
                <div class="card-footer">
                    <div class="">
                        ...
                        <p class="float-sm-right text-center m-0">New to Stack? <a href="register-simple.html"
    ...
    <script src="vendors/js/forms/icheck/icheck.min.js"></script>
