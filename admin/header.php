...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/pages/timeline.min.css">
    <!-- END: Page CSS-->
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-modern-menu-template/index.html"><img class="brand-logo" alt="stack admin logo" src="images/logo/stack-logo-light.png">
                <h2 class="brand-text">BPL</h2></a></li>
            <li class="nav-item d-none d-lg-block nav-toggle"><a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse"><i class="white fa fa-chevron-left" data-ticon="feather.icon-toggle-right"></i></a></li>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            <ul class="nav navbar-nav mr-auto float-left">
              ...
              <li class="nav-item d-none d-md-block"><a class="nav-link nav-link-expand" href="#"><i class="fa fa-window-maximize"></i></a></li>

              <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="fa fa-user"></i> <?php if ($user_id==1) {
                echo "Admin";
              } else {
                echo "Vendor";
              } ?></a>
              <!-- <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="fa fa-search"></i></a> -->
                <div class="search-input">
                  ...
                  <div class="search-input-close"><i class="fa fa-close"></i></div>
            ...
            <ul class="nav navbar-nav float-right">
                  ...
                  <li class="scrollable-container media-list"><a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left">
                          <div class="avatar avatar-online avatar-sm rounded-circle"><img src="images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></div>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <div class="avatar avatar-online avatar-sm rounded-circle"><img src="images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></div>
                        </div>
                        <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  <div class="avatar avatar-online"><img src="images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></div><span class="user-name"><?php echo $username; ?></span></a>
                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="user-profile.html"><i class="fa fa-user"></i> My Profile</a>
                  <div class="dropdown-divider"></div><a class="dropdown-item" href="logout.php"><i class="fa fa-power-off"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="nav-item <?php if($url=='dashboard.php'){ echo 'active';} ?>"><a href="dashboard.php"><i class="fa fa-home"></i><span class="menu-title" data-i18n="Email Application">Dashboard</span></a>
          </li>

            <li class="nav-item <?php if($url=='sales.php'){ echo 'active';} ?>"><a href="sales.php"><i class="fa fa-inr"></i><span class="menu-title" data-i18n="Email Application">&nbsp; Sales</span></a>
          </li>

           <li class="nav-item <?php if($url=='users.php'){ echo 'active';} ?>"><a href="users.php"><i class="fa fa-user"></i><span class="menu-title" data-i18n="Email Application">Users</span></a>
          </li>

          <!--  <li class=" nav-item"><a href="#"><i class="fa fa-shopping-cart"></i><span class="menu-title" data-i18n="Dashboard">Vendor</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
            <ul class="menu-content">
              <li class="<?php if($url=='vendor.php'){ echo 'active';} ?>"><a class="menu-item" href="vendor.php" data-i18n="Analytics">Vendor</a>
              </li>
              <li class="<?php if($url=='vendor_city.php'){ echo 'active';} ?>"><a class="menu-item" href="vendor_city.php" data-i18n="Fitness">Vendor City</a>
              </li>
          ...
          <li class=" nav-item"><a href="#"><i class="fa fa-shopping-cart"></i><span class="menu-title" data-i18n="Dashboard">Product</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
            <ul class="menu-content">
              <li class="<?php if($url=='category.php'){ echo 'active';} ?>"><a class="menu-item" href="category.php" data-i18n="Analytics">Category</a>
              </li>
             <!--  <li class="<?php if($url=='lbl_category.php'){ echo 'active';} ?>"><a class="menu-item" href="lbl_category.php" data-i18n="Analytics">Label Category</a>
              </li> -->
              <li class="<?php if($url=='subcategory.php'){ echo 'active';} ?>"><a class="menu-item" href="subcategory.php" data-i18n="Fitness">Sub Category</a>
              </li>
              <li class="<?php if($url=='products.php'){ echo 'active';} ?>"><a class="menu-item" href="products.php" data-i18n="eCommerce">Product</a>
              </li>
          ...
          <!-- <li class="nav-item <?php if($url=='qr_generate.php'){ echo 'active';} ?>"><a href="qr_generate.php"><i class="fa fa-qrcode"></i><span class="menu-title" data-i18n="Email Application">QR Generate</span></a>
          </li> -->
          ...
          <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-1-column.html" data-i18n="1 column">1 column</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-2-columns.html" data-i18n="2 columns">2 columns</a>
              </li>
              <li><a class="menu-item" href="#" data-i18n="Content Det Sidebar">Content Det Sidebar</a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-left-sidebar.html" data-i18n="Detached left sidebar">Detached left sidebar</a>
                  </li>
                  <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-left-sticky-sidebar.html" data-i18n="Detached sticky left sidebar">Detached sticky left sidebar</a>
                  </li>
                  <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-right-sidebar.html" data-i18n="Detached right sidebar">Detached right sidebar</a>
                  </li>
                  <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-right-sticky-sidebar.html" data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</a>
                  </li>
                </ul>
              </li>
              <li class="navigation-divider"></li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-fixed-navbar.html" data-i18n="Fixed navbar">Fixed navbar</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-fixed-navigation.html" data-i18n="Fixed navigation">Fixed navigation</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-fixed-navbar-navigation.html" data-i18n="Fixed navbar &amp; navigation">Fixed navbar &amp; navigation</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-fixed-navbar-footer.html" data-i18n="Fixed navbar &amp; footer">Fixed navbar &amp; footer</a>
              </li>
              <li class="navigation-divider"></li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-fixed.html" data-i18n="Fixed layout">Fixed layout</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-boxed.html" data-i18n="Boxed layout">Boxed layout</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-static.html" data-i18n="Static layout">Static layout</a>
              </li>
              <li class="navigation-divider"></li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-light.html" data-i18n="Light layout">Light layout</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-dark.html" data-i18n="Dark layout">Dark layout</a>
              </li>
              <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-semi-dark.html" data-i18n="Semi dark layout">Semi dark layout</a>
              </li>
            </ul>
          </li>
